...
def main():
    ...
    # print setosa
    # setosa = np.c_[setosa, np.random.randn(len(setosa), 1)+0]
    # versicolor = np.c_[versicolor, np.random.randn(len(versicolor), 1)+0]
    # virginica = np.c_[virginica, np.random.randn(len(virginica), 1)+0]
    # print setosa
    ...
    for index, kernel in enumerate(kernels):
        ...
        if False:
            ...
            print results
            joblib.dump(clf, 'data/SVM/SVM_clf')
